...
use MU\YourAnswersModule\Block\Form\Type\ItemBlockType;
...
abstract class AbstractItemBlock extends AbstractBlockHandler
{
    ...
    {
        return $this->__('Your answers detail', 'muyouranswersmodule');
    }
    ...
    public function display(array $properties = [])
    {
        ...
        if (!$this->hasPermission('MUYourAnswersModule:ItemBlock:', "$properties[title]::", ACCESS_OVERVIEW)) {
            return '';
        }
        ...
        $controllerReference = new ControllerReference('MUYourAnswersModule:External:display', $this->getDisplayArguments($properties), ['template' => $properties['customTemplate']]);
    ...
    {
        return '@MUYourAnswersModule/Block/item_modify.html.twig';
    }
