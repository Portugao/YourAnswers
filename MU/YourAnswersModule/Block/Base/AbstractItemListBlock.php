...
use MU\YourAnswersModule\Block\Form\Type\ItemListBlockType;
...
abstract class AbstractItemListBlock extends AbstractBlockHandler
{
    ...
    {
        return $this->__('Your answers list', 'muyouranswersmodule');
    }
    ...
    public function display(array $properties = [])
    {
        ...
        if (!$this->hasPermission('MUYourAnswersModule:ItemListBlock:', "$properties[title]::", ACCESS_OVERVIEW)) {
            return '';
        }
        ...
        // create query
        $orderBy = $this->get('mu_youranswers_module.model_helper')->resolveSortParameter($objectType, $properties['sorting']);
        ...
        if (empty($properties['title'])) {
            $properties['title'] = $this->__('Your answers list', 'muyouranswersmodule');
        }
        ...
        $templateParameters = $this->get('mu_youranswers_module.controller_helper')->addTemplateParameters($properties['objectType'], $templateParameters, 'block', []);
    ...
    protected function getDisplayTemplate(array $properties = [])
    {
        ...
        foreach ($templateOptions as $templatePath) {
            if ($templating->exists('@MUYourAnswersModule/' . $templatePath)) {
                $template = '@MUYourAnswersModule/' . $templatePath;
                break;
            }
        }
    ...
    {
        return '@MUYourAnswersModule/Block/itemlist_modify.html.twig';
    }
