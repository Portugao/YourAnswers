...
use MU\YourAnswersModule\Entity\Factory\EntityInitialiser;
...
abstract class AbstractEntityFactory
{
    ...
    {
        $entityClass = 'MU\\YourAnswersModule\\Entity\\' . ucfirst($objectType) . 'Entity';
     ...
     *
     * @return MU\YourAnswersModule\Entity\answerEntity The newly created entity instance
     */
    public function createAnswer()
    {
        $entityClass = 'MU\\YourAnswersModule\\Entity\\AnswerEntity';
     ...
     *
     * @return MU\YourAnswersModule\Entity\questionEntity The newly created entity instance
     */
    public function createQuestion()
    {
        $entityClass = 'MU\\YourAnswersModule\\Entity\\QuestionEntity';
    ...
    public function getIdField($objectType = '')
    {
        ...
        $entityClass = 'MUYourAnswersModule:' . ucfirst($objectType) . 'Entity';
