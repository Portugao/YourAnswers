...
abstract class AbstractAnswerRepository extends EntityRepository
{
     ...
     */
    protected $mainEntityClass = 'MU\YourAnswersModule\Entity\AnswerEntity';
    ...
    public function updateCreator($userId, $newUserId, TranslatorInterface $translator, LoggerInterface $logger, CurrentUserApiInterface $currentUserApi)
    {
        ...
        $logArgs = ['app' => 'MUYourAnswersModule', 'user' => $currentUserApi->get('uname'), 'entities' => 'answers', 'userid' => $userId];
    ...
    public function selectByIdList($idList = [0], $useJoins = true, $slimMode = false)
    {
        ...
        if (!$slimMode && null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->applyDefaultFilters('answer', $qb);
        }
