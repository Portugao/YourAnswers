...
abstract class AbstractQuestionRepository extends EntityRepository
{
     ...
     */
    protected $mainEntityClass = 'MU\YourAnswersModule\Entity\QuestionEntity';
    ...
    public function updateCreator($userId, $newUserId, TranslatorInterface $translator, LoggerInterface $logger, CurrentUserApiInterface $currentUserApi)
    {
        ...
        $logArgs = ['app' => 'MUYourAnswersModule', 'user' => $currentUserApi->get('uname'), 'entities' => 'questions', 'userid' => $userId];
    ...
    public function selectByIdList($idList = [0], $useJoins = true, $slimMode = false)
    {
        ...
        if (!$slimMode && null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->applyDefaultFilters('question', $qb);
        }
