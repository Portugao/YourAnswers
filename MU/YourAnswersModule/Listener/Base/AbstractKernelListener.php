...
abstract class AbstractKernelListener implements EventSubscriberInterface
{
     ...
     *     `$testMessage = 'Hello from your answers app';
     *     $event->getRequest()->attributes->set('MUYourAnswersModule_test', $testMessage);`
     *
     ...
     *     `$testMessage = $event->getRequest()->attributes->get('MUYourAnswersModule_test');`
     *     now `$testMessage` should be: `'Hello from your answers app'`
     *
     ...
     *         $response = new Response();
     *         $message = sprintf('your answers App Error says: %s with code: %s', $exception->getMessage(), $exception->getCode());
