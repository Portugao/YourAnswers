...
namespace MU\YourAnswersModule\Form\Type\Finder\Base;
...
/**
 * Answer finder form type base class.
 */
abstract class AbstractAnswerFinderType extends AbstractType
{
    use TranslatorTrait;
    ...
    public function addPasteAsField(FormBuilderInterface $builder, array $options = [])
    {
        $builder->add('pasteAs', ChoiceType::class, [
            ...
            'empty_data' => 1,
            'choices' => [
                $this->__('Relative link to the answer') => 1,
                $this->__('Absolute url to the answer') => 2,
                $this->__('ID of answer') => 3
            ],
            'multiple' => false,
            'expanded' => false
        ]);
    ...
    {
        return 'muyouranswersmodule_answerfinder';
    }
