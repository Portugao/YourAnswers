...
namespace MU\YourAnswersModule\Form\Handler\Question\Base;

use MU\YourAnswersModule\Form\Handler\Common\EditHandler;
use MU\YourAnswersModule\Form\Type\QuestionType;
...
abstract class AbstractEditHandler extends EditHandler
{
    ...
    public function processForm(array $templateParameters = [])
    {
        ...
        if ('create' == $this->templateParameters['mode']) {
            if (!$this->modelHelper->canBeCreated($this->objectType)) {
                $this->requestStack->getCurrentRequest()->getSession()->getFlashBag()->add('error', $this->__('Sorry, but you can not create the question yet as other items are required which must be created before!'));
    ...
    protected function getDefaultReturnUrl(array $args = [])
    {
        ...
        if ($objectIsPersisted) {
            // redirect to the detail page of treated question
    ...
    public function applyAction(array $args = [])
    {
        ...
        try {
            ...
            $logArgs = ['app' => 'MUYourAnswersModule', 'user' => $this->currentUserApi->get('uname'), 'entity' => 'question', 'id' => $entity->getKey(), 'errorMessage' => $exception->getMessage()];
