...
namespace MU\YourAnswersModule\ContentType\Base;

use Symfony\Component\HttpKernel\Controller\ControllerReference;
use Symfony\Component\HttpKernel\Fragment\FragmentHandler;
use Zikula\Common\Content\AbstractContentType;
use MU\YourAnswersModule\ContentType\Form\Type\ItemType as FormType;
...
abstract class AbstractItemType extends AbstractContentType
{
    ...
    {
        return $this->translator->__('Your answers detail', 'muyouranswersmodule');
    }
    ...
    {
        return $this->translator->__('Display or link a single your answers object.', 'muyouranswersmodule');
    }
    ...
    public function displayView()
    {
        ...
        $controllerReference = new ControllerReference('MUYourAnswersModule:External:display', $this->getDisplayArguments(), ['template' => $this->data['customTemplate']]);
    ...
    {
        if (null === $this->data['id'] || empty($this->data['id']) || empty($this->data['displayMode'])) {
            return $this->translator->__('No item selected.', 'muyouranswersmodule');
        }
