...
use MU\YourAnswersModule\ContentType\Form\Type\ItemListType as FormType;
...
abstract class AbstractItemListType extends AbstractContentType
{
    ...
    {
        return $this->translator->__('Your answers list', 'muyouranswersmodule');
    }
    ...
    {
        return $this->translator->__('Display a list of your answers objects.', 'muyouranswersmodule');
    }
    ...
    public function getViewTemplatePath($suffix = '')
    {
        ...
        foreach ($templateOptions as $templatePath) {
            if ($this->twigLoader->exists('@MUYourAnswersModule/' . $templatePath)) {
