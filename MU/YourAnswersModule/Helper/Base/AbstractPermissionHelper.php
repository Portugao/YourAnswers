...
abstract class AbstractPermissionHelper implements ContainerAwareInterface
{
    ...
    public function hasEntityPermission($entity, $permissionLevel, $userId = null)
    {
        ...
        return $this->permissionApi->hasPermission('MUYourAnswersModule:' . ucfirst($objectType) . ':', $instance, $permissionLevel, $userId);
    }
    ...
    {
        return $this->permissionApi->hasPermission('MUYourAnswersModule:' . ucfirst($objectType) . ':', '::', $permissionLevel, $userId);
    }
    ...
    {
        return $this->permissionApi->hasPermission('MUYourAnswersModule::', '::', $permissionLevel, $userId);
    }
